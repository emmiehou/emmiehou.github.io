...
class FedProcessorApp:
    ...
    def create_file_selection_frame(self, parent):
        ...
        select_btn = ttk.Button(frame, text="Select CSV Files", command=self.select_files)
        select_btn.pack(side=tk.LEFT, padx=5)
        
        clear_btn = ttk.Button(frame, text="Clear Selection", command=self.clear_selection)
        clear_btn.pack(side=tk.LEFT, padx=5)
        
        self.file_count_label = ttk.Label(frame, text="No files selected")
        self.file_count_label.pack(side=tk.LEFT, padx=20)
    
    def create_file_list_frame(self, parent):
        frame = ttk.LabelFrame(parent, text="Selected Files", padding="10")
    ...
    def create_status_frame(self, parent):
        ...
        self.status_label = ttk.Label(frame, text="Ready to process files")
    ...
    def create_action_buttons_frame(self, parent):
        ...
        process_btn = ttk.Button(frame, text="Process Files", command=self.process_files)
        process_btn.pack(side=tk.LEFT, padx=5)
        
        save_btn = ttk.Button(frame, text="Save Results", command=self.save_results)
        save_btn.pack(side=tk.LEFT, padx=5)
        
        reset_btn = ttk.Button(frame, text="Reset", command=self.reset_app)
        reset_btn.pack(side=tk.LEFT, padx=5)
        
        exit_btn = ttk.Button(frame, text="Exit", command=self.root.destroy)
